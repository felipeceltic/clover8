  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Inclusão de receitas</h5>

            <!-- Floating Labels Form -->
            <form class="row g-3" method="POST" action="{{ route('finance.income.store') }}">
              @csrf
              <div class="col-12">
                <div class="form-floating border border-primary border-opacity-75 rounded">
                  ...
                  <label for="date">Data do recebimento</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-floating border border-primary border-opacity-75 rounded">
